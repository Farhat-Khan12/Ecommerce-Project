        ...
        <div>
            ...
            <h2 className='text-left'>My Account</h2>
                ...
                <Row  className="d-flex justify-content-md-center text-center font-size" style={{fontSize:"17px"}}>
                    <Col md={4} >
                    <br />
                    <img src="" alt='dp' className="rounded-circle"/><br />
                    ...
                    <Row className='text-left '>
                        <Col xs={4}>
                        <Button variant='outline-secondary'className='font-weight-bold my-3'> <MdEdit className='mr-2'/>Edit</Button>
                        </Col>
                    </Row>
                    <hr color='black'/>
...
export default ReusableAccPage
