        ...
        <Annoucement/>
            ...
            <Container>
                {loading ? (
                    <Loading>
                        <h1>Loading...</h1>
                        <iframe src="https://giphy.com/embed/fWAwHYOB1XbIvhHKQU" width="480" height="540" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/fWAwHYOB1XbIvhHKQU"></a></p>
                    </Loading>
                ) : error ? (
                    <p>{error}</p>
                ) : (
