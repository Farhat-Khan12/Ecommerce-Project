    ...
    return (
        <>
            <Container>
                ...
                <Row style={{ fontSize: "25px", marginLeft: "40px" }}>
                    <Button className="btn btn-warning" style={{ marginRight: "20px", marginTop: "50px", color: "black", fontWeight: 'bold' }}
                        onClick={() => addToCartHandler(Product._id, Product.productName, Product.productImage, Product.productProducer, Product.productCost, Product.productStock, quantity)}
                    >Add To Cart</Button>
